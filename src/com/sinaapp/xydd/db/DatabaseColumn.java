...
public abstract class DatabaseColumn implements BaseColumns {
	 ...
	 */
	public static final String AUTHORITY = "com.sinaapp.xydd.provider";
	/**
	 * The database's name
	 */
	...
	public static final String[] SUBCLASSES = new String[] {
			"com.sinaapp.xydd.db.BlogColumn", "com.sinaapp.xydd.db.NewsColumn",
			"com.sinaapp.xydd.db.DetailColumn", "com.sinaapp.xydd.db.ImageCacheColumn",
			"com.sinaapp.xydd.db.RequestCacheColumn" };
