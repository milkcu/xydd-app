...
import com.sinaapp.xydd.biz.DetailDao;
import com.sinaapp.xydd.db.DetailColumn;
import com.sinaapp.xydd.db.biz.DetailDB;
...
import com.sinaapp.xydd.utils.CommonUtil;
        ...
        switch (v.getId()) {
            ...
            case R.id.rlDiscuss:
                ...
                IntentUtil.start_activity(DetailsActivity.this,
                        ...
                        "title", mTitle));
                */
            	IntentUtil.start_activity(DetailsActivity.this, DetailsDiscussActivity.class);
                break;
        }
        if (url != null) {
