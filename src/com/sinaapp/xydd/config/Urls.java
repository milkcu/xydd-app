package com.sinaapp.xydd.config;
...
//	public static final String BASIC_URL1 = "http://api.eoe.name/client";
	 ...
	 * 博客请求地址
	 */
	//public static final String TOP_LIST = BASIC_URL + "/top.php";
	public static final String TOP_LIST = "http://xyddws.sinaapp.com/api/list.php";
	public static final String BLOGS_LIST = BASIC_URL + "/blog.php?k=lists";
	//public static final String NEWS_LIST = BASIC_URL + "/news.php?k=lists";
	public static final String NEWS_LIST = "http://xyddapp.sinaapp.com/api/list.php?lpage=1";
	public static final String WIKI_LIST = BASIC_URL + "/wiki.php?k=lists";
